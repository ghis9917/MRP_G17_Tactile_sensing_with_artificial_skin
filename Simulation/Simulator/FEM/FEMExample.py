...
class RectWall():
    ...
    # Constructor
    def __init__(self, width, height, thickness, E=3824, nu=0.3, mesh_size=1, bot_support='Pinned',
                 top_support='Pinned', left_support='Free', right_support='Free'):
        ...
        for control_point in iter_y:
            ...
            for j in range(num_rows):
                for i in range(num_cols):
                    ...
                    self.fem.AddPlate('P' + str(pl_id), 'N' + str(ni), 'N' + str(nj), 'N' + str(nm), 'N' + str(nn),
                                      self.thickness, self.E, self.nu)
...
Visualization.RenderModel(myWall.fem, text_height=meshsize / 6, deformed_shape=False, deformed_scale=30,
